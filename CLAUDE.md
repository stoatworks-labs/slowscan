...
- Serve it: `python3 -m http.server 8947` from `demo/`
- Its shaders are still the plugin's: `python3 demo/tools/check_shaders.py` (in `verify.sh`)
- Verify a deploy **by content, never by status code**:
