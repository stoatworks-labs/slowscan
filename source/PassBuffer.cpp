...
bool PassBuffer::Ensure( GLsizei requestedWidth, GLsizei requestedHeight, GLint format )
{
	...
	//A freshly allocated framebuffer's contents are undefined, and the first
	//readback after a mode change would otherwise hand the transmitter
	//whatever texture memory the driver had lying about.
	GLint previousFBO = 0;
