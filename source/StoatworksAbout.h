...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Slow-scan TV over a fading HF path, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/slowscan/guide/";
